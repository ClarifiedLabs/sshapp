...
//
    ...
    extension UITerminalView {
        ...
        /// internal path used by the bundled UIKit accessory.
        public func performInputAccessoryItem(_ item: TerminalInputAccessoryItem) {
            switch item {
            case .esc:
                handleInputBarKey(.esc)
            case .tab:
                handleInputBarKey(.tab)
            case .ctrl:
                toggleStickyModifier(.ctrl)
            case .alt:
                toggleStickyModifier(.alt)
            case .command:
                toggleStickyModifier(.command)
            case .arrowLeft:
                handleInputBarKey(.arrowLeft)
            case .arrowUp:
                handleInputBarKey(.arrowUp)
            case .arrowDown:
                handleInputBarKey(.arrowDown)
            case .arrowRight:
                handleInputBarKey(.arrowRight)
            case let .symbol(symbol):
                handleInputBarKey(.symbol(symbol))
            case .paste:
